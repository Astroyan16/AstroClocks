; Inno Setup script for AstroClocks v3.4.1.
...
[Setup]
; Keep the AppId stable so v3.4.1 upgrades the same AstroClocks application.
...
OutputDir=installer
OutputBaseFilename=Install_AstroClocks3.4.1
