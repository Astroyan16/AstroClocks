...
TRANSLATIONS = {
    "en": {
        ...
        "frame.hour_angle": "Hour Angle (EAST circle +6h)",
        "frame.declination": "Declination (+90deg)",
    ...
    "fr": {
        ...
        "frame.hour_angle": "Angle horaire (cercle EST +6h)",
        "frame.declination": "Declinaison (+90deg)",
